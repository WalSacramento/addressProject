...
import { useModalUpdateController } from './modalUpdate.controller'

export default function ModalUpdateEndereco(id) {
  const [isOpen, setIsOpen] = useState(false)

  const { errors, handleSubmit, onSubmit, register } = useModalUpdateController(
    setIsOpen,
    id.id
  )
